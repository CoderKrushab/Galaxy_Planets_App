...
class _planetState extends State<planet> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final args = ModalRoute.of(context)!.settings.arguments as GalaxyPlanet;
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    style:
                        const TextStyle(color: Color(0xffC2BDEA), fontSize: 22),
                  ),
                  const SizedBox(
                    height: 20,
                  ),
    ...
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 75,
        title: const Text("Galaxy Details", style: TextStyle(fontSize: 28),),
        centerTitle: true,
        backgroundColor: const Color(0xFF3E3963),
      ),
      body: ListView(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Image.asset('galaxy/ic_distance.png', width: 20),
                        const SizedBox(
                          width: 5,
                        ),
                        Text(
                        ...
                        const Spacer(),
                        Image.asset('galaxy/ic_gravity.png', width: 20),
                        const SizedBox(
                          width: 5,
                        ),
                        Text(
